  ...
  const faqData = [
    {
      ...
      a: "Yes, we offer a short-term stay option.",
      answer:
    ...
    },
    {
      ...
      a: "Yes, pets are welcome in designated areas.",
      answer:
    ...
    },
    {
      ...
      a: "Meals, activities, and daily care are included.",
      answer:
    ...
    },
    {
      ...
      a: "Yes, visits are welcome during visiting hours.",
      answer:
