...
export function DashboardSidebar(props: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    <Sidebar
      className="border-r-0 w-[312px] h-svh text-[#68706A] bg-[#FFFFFF]"
      collapsible="none"
      {...props}
    >
      <SidebarContent className="p-4 ">
        ...
        <SidebarMenu className="space-y-2">
          ...
          {/* Logout under Settings, aligned with sub-items */}
          <Dialog>
            <DialogTrigger asChild>
              <SidebarMenuItem>
                <SidebarMenuButton
                  className="group py-2 px-4  w-full flex items-start
                 hover:bg-[#28A745] rounded cursor-pointer"
                >
                  <LogOut className="h-4 w-4 text-gray-400 group-hover:text-white mr-5" />
