      ...
      <div className="container mx-auto space-y-4 lg:space-y-20 py-10 px-4 sm:py-12 sm:px-6 md:py-16 md:px-8 lg:py-20 lg:px-12 xl:p-20 ">
        <div className="">
          <div className="text-center mb-8 sm:mb-10 md:mb-12">
            <h1 className="text-2xl  font-playfair  sm:text-3xl md:text-4xl lg:text-4xl font-bold text-gray-900 mb-4 sm:mb-5 md:mb-6">
            ...
            <p className="text-gray-600 w-full mx-auto text-sm sm:text-base leading-relaxed px-2 sm:px-0">
              Trusted, transparent, and easy to use — everything families need to
              find the perfect care for their loved ones.
            </p>
          </div>
        </div>
