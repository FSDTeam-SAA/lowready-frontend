...
export default function PrivacyPolicy() {
  return (
    <section className="bg-[#F8F9FA]">
      <div className="mx-auto container py-6 md:py-12">
        <h1 className="text-[#191D23] text-2xl font-semibold mb-4">
          What is Assisted Living?
        </h1>
        <p className="text-[#68706A] text-base mb-4">
          ...
          sodales elit iaculis eu. Donec rutrum orci eu aliquam interdum. Morbi
          ac rhoncus nunc. Mauris dictum hendrerit ornare. Donec sed justo
          ornare, scelerisque nulla id, tincidunt turpis. Ut eget dolor eu
          sapien pulvinar facilisis scelerisque in tortor. Quisque vehicula
          finibus placerat. Sed tempus molestie purus, a rutrum justo dapibus
          ut. Donec eget est at sem volutpat facilisis. Vestibulum accumsan
          neque arcu, at porttitor dui facilisis elementum.
        </p>
        <p className="text-[#68706A] text-base mb-4">
          ...
          malesuada aliquam. Phasellus sit amet nulla odio. Integer quis sapien
          sed dolor pharetra rhoncus. Sed condimentum ex sed libero auctor
          dictum. Curabitur efficitur, turpis eget facilisis lobortis, eros
          massa dapibus dui, euismod porta felis ex id metus. Vestibulum
          tincidunt gravida nulla, ut interdum velit venenatis ac. Nulla et
          ultricies tellus. Ut posuere a nisi eu vulputate. Ut id lacus
          imperdiet, ornare risus sit amet, egestas nisi. Duis pulvinar faucibus
          orci sed placerat.
        </p>

        <h2 className="text-[#191D23] text-xl font-semibold mt-10 mb-2">
          Key Considerations When Choosing a Facility
        </h2>
        <ol className="list-decimal list-inside text-[#68706A] mb-6 space-y-2">
          <li>
        ...
        <h2 className="text-[#191D23] text-xl font-semibold mt-4 mb-2">
          Questions to Ask During a Visit
        </h2>
        <ul className="list-disc list-inside text-[#68706A] space-y-2 mb-6">
